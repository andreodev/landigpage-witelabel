...
export default function UserExperience() {
    return (
        <section
            className="bg-gradient-to-r to-[#6D03F5] from-[#D74B18] text-white flex flex-col items-center justify-start min-h-svh py-20 px-6"
            id="experiencia"
        >
            {/* Texto em cima */}
            <div className="max-w-6xl text-center">
                ...
                <p className="mt-5 max-w-[600px] mx-auto">Nossa equipe de UX/UI trabalha constantemente para criar a melhor experiência de pagamento possível, resultando em maiores taxas de conversão.</p>
            </div>
